                                ...
                                <div class="course-box__main">
                                  ...
                                  <div class="course-box__rating-teacher">
                                    ...
                                    ${Array(5 - course.courseAverageScore)
                                      ...
                                      .map(
                                        (score) =>
                                          '<img src="images/svgs/star.svg" alt="rating" class="course-box__stars">'
                                      )
                                      .join(" ")}
                                    ${Array(course.courseAverageScore)
                                      ...
                                      .map(
                                        (score) =>
                                          '<img src="images/svgs/star_fill.svg" alt="rating" class="course-box__stars">'
                                      )
                                      .join(" ")}
                                  ...
                                  <div class="course-box__status">
                                    ...
                                    <span class="course-box__price">${formattedPrice}</span>
                                  </div>
                                </div>
                        ...
                        <div class="article-card">
                            <div class="article-card__header">
                                <a href="#" class="article-card__link-img">
                                    <img src=http://localhost:4000/courses/covers/${article.cover} class="article-card__img" alt="Article">
                                </a>
                            </div>
